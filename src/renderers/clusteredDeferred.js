...
export default class ClusteredDeferredRenderer extends BaseRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._progShade = loadShaderProgram(QuadVertSource, fsSource({
      ...
      uniforms: ['u_gbuffers[0]', 'u_gbuffers[1]', 'u_gbuffers[2]', 'u_gbuffers[3]',
        ...
        'u_viewMatrix', 'u_width', 'u_height', 'u_near', 'u_far', 'u_xSlices', 'u_ySlices', 'u_zSlices',
        'u_pixelsPerElement', 'u_elementCount', 'u_camPos'],
      attribs: ['a_uv'],
    });
  ...
  render(camera, scene) {
    ...
    // width, height, and near and far clip planes
    ...
    // pixelsPerElement and elementCount
    gl.uniform1i(this._progShade.u_pixelsPerElement, this._clusterTexture._pixelsPerElement);
    gl.uniform1i(this._progShade.u_elementCount, this._clusterTexture._elementCount);

    // camera position for Blinn Phong
